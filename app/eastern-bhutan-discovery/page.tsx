...
import { tourInfo, mockTourData, photoSets, newTourPackageData, eaternBhutanData, eaternBhutandiscoveryData } from "@/data/paro-places-data";
 ...
 const itinerary = [
  {
    ...
    subtitle: "",
     leftImages: [
      { src: "/photo16.jpg", alt: "Paro Airport" },
      { src: "/photo14.jpg", alt: "Farewell Bhutan" },
    ],
    rightImage: "/punakha-valley.jpg",
    videoUrl: "",
    content: `
...
Overnight in Samdrup Jongkhar
  ...
  },
  {
    ...
    subtitle: "",
    leftImages: [
      { src: "/sam1.jpg", alt: "Paro Airport" },
      { src: "/sam2.jpg", alt: "Farewell Bhutan" },
    ],
...
Overnight in Trashigang
  ...
  },
  {
    ...
    subtitle: "",
    leftImages: [
      { src: "/sam8.jpg", alt: "Paro Airport" },
      { src: "/scollege.jpg", alt: "Farewell Bhutan" },
    ],
...
Overnight in Trashiyangtse
  ...
  },
  {
    ...
    subtitle: "",
     leftImages: [
      { src: "/restraurant.jpg", alt: "Paro Airport" },
      { src: "/s_mountain.jpg", alt: "Farewell Bhutan" },
    ],
...
Overnight in Pema Gatshel
  ...
  },
  {
    ...
    subtitle: "",
    leftImages: [
      { src: "/The lake.jpg", alt: "Paro Airport" },
      { src: "/The Takila.jpg", alt: "Farewell Bhutan" },
    ],
...
Overnight in Samdrup Jongkhar
  ...
  },
  {
    ...
    subtitle: "",
    leftImages: [
      { src: "/tangvalley.jpg", alt: "Paro Airport" },
      { src: "/sixsense.jpg", alt: "Farewell Bhutan" },
    ],
    rightImage: "/sam7.jpg",
    videoUrl: "",
    content: `
    ...
    return (
        <main className="w-full h-full">
            ...
            <div className=" bg-[#EAEDF0] pt-3 pb-10">
                <TourAbout data={eaternBhutandiscoveryData} />
            </div>
