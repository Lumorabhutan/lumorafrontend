...
export default function Navbar({
    ...
    return (
        <header className="sticky top-0 z-40 flex items-center bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 px-6 py-3 md:px-6 transition-colors">
            {/* LEFT */}
